...
<body>
    <div class="container p-5 my-5 bg-dark text-white">
        <h1>Database to Web with PHP : Lesson3</h1>
    ...
    <div class="container mt-3">
        ...
        <div class="btn-group btn-group-lg">
            ...
            <button type="button" class="btn btn-info"onclick="window.location.href ='Lesson3.php'">Lesson 2 : แสดงข้อมูลเฉพาะ SECT_TELEPHONE และ SECT_NAME โดยเรียงจาก SECT_NAME จาก A-Z
        </div>
